...
module.exports.CAT_GUIDE = {
  ...
  legal: { ko: { when: ["수사·행정·사법 절차에 제출하는 문서가 필요할 때"], tips: ["제출처(관할 기관)를 먼저 확인", "사실 관계는 시간 순서로 객관적으로"], caution: "공식 문서는 허위 기재 시 불이익이 있습니다. 중요한 사건은 전문가 상담을 권합니다." } },
  ...
  work: { ko: { when: ["고용 관계에서 필요한 서면 문서를 작성할 때"], tips: ["법정 기재사항이 빠지지 않도록", "당사자 각 1부씩 보관"], caution: "근로관계는 근로기준법 등 강행규정이 우선 적용됩니다." } },
  personal: { ko: { when: ["개인 간 권리·의무를 문서로 남길 때"], tips: ["당사자 정보와 날짜를 정확히", "중요 문서는 서명·날인 후 보관"], caution: "가사·상속 등 민감 사안은 전문가 상담을 권합니다." } },
